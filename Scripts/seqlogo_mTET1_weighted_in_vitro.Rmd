...
```{r}
filename <-"../Datasets/mTET1-CpN-FM-Compilation-Forward_kinetics.xlsx"
sheet <- "all"
range1 <- "E26:IY34"
range2 <- "E82:IY83"
range3 <- "E85:IY86"
...
i.e. the correlation is similar for data that were and were not used for prediction of the model. 